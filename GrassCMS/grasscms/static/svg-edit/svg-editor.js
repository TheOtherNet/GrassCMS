	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				imgPath: 'images/',
				langPath: 'locale/',
				extPath: 'http://grasscms.com/static/svg-edit/extensions/',
		...
		Editor.init = function() {
			...
			$.svgIcons(window.icons_location, {
				w:24, h:24,
				id_match: false,
				no_img: true,
			...
			var palette = ["#000000", "#3f3f3f", "#7f7f7f", "#bfbfbf", "#ffffff",
				...
				default_img_url = "http://grasscms.com/static/svg-edit/images/logo.png",
				workarea = $("#workarea"),
				show_save_warning = false, 
				exportWindow = null;
							...
							if(opts.key) {
								...
								if(opts.sel && !opts.hidekey) {
									try{
                                        ...
                                        console.debug("This stuff at line 3333");
                                    }
								}
							}
						});
